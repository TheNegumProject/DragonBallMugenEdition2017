;COMANDOS BILLS BY MUGENMUNDO -- É AQUI ONDE A MAGIA ACONTECE .. LITERALMENTE!
...
;-----------------------------------------------------------------
[Command]
name = "Chutes pra baixo"
command =D,F,a
time = 9
;-----------------------------------------------------------------
[Command]
name = "Socos pra baixo"
command =D,F,b
time = 9
;-----------------------------------------------------------------
[Command]
...
trigger3= stateno = 1500
;----------------------------------------------
;Chutes indo pra baixo
[State -1, Chutes pra baixo]
type = ChangeState
value = 664
triggerall = command = "Chutes pra baixo"
...
triggerall=power>170
;--------------------------------------------
;Socos  indo pra baixo
[State -1, Socos  pra baixo]
type = ChangeState
value = 665
triggerall = command = "Socos pra baixo"
trigger1 = (statetype = A) && ctrl
triggerall = var (9) =0
trigger2 = stateno = 200
trigger2 = time > 18
...
;---------------------------------------------------------------------------
;Destruir a Terra
[State -1,Destruir a Terra]
type = ChangeState
value = 1999
triggerall = command = "Destruir Terra"
triggerall = var (9) =0
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 18
...
trigger3= stateno = 1500
;---------------------------------------------------------------------------
[State -1, Explosão Cintilante]
type = ChangeState
value = 1996
triggerall = command = "Explosão Cintilante"
triggerall = var (9) =0
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 18
...
;Explodir Tudo
[State -1,Explodir Tudo]
type = changestate
value = 5999
trigger1 = command = "Explodir Tudo"
trigger1 = (statetype = s) && ctrl
trigger2 = stateno = 200
trigger2 = time > 18
triggerall=power>2800
